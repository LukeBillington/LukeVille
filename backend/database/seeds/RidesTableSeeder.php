...
class RidesTableSeeder extends Seeder
{
    ...
    public function run()
    {
      Ride::create([
          ...
          'header_path' => '/img/ride-headers/1.png',
      ]);
      ...
      Ride::create([
          ...
          'header_path' => '/img/ride-headers/2.png',
      ]);
      ...
      Ride::create([
          ...
          'header_path' => '/img/ride-headers/3.png',
      ]);
      ...
      Ride::create([
          ...
          'header_path' => '/img/ride-headers/4.png',
      ]);
      ...
      Ride::create([
          ...
          'header_path' => '/img/ride-headers/5.png',
      ]);
      ...
      Ride::create([
          ...
          'header_path' => '/img/ride-headers/6.png',
      ]);
      ...
      Ride::create([
          ...
          'header_path' => '/img/ride-headers/7.png',
      ]);
      ...
      Ride::create([
          ...
          'header_path' => '/img/ride-headers/8.png',
      ]);
      ...
      Ride::create([
          ...
          'header_path' => '/img/ride-headers/9.png',
      ]);
      ...
      Ride::create([
          ...
          'header_path' => '/img/ride-headers/10.png',
      ]);
      ...
      Ride::create([
          ...
          'header_path' => '/img/ride-headers/11.png',
      ]);
      ...
      Ride::create([
          ...
          'header_path' => '/img/ride-headers/12.png',
      ]);
    }
}
